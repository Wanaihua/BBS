...
<html>
  ...
  <div class="bg">
	...
	<div class="rig">
    <form:form  name="form1" id="form1" action="insert.do" method="post">
    	<table cellspacing="10px">
    		...
    		<tr>
    			<td><spring:message code="userPass"></spring:message></td>
    			<td><form:input path="userPass" type="password" id="pw1"/><form:errors path="userPass"></form:errors></td>
    		</tr>
    		...
    		<tr>
    			<td><spring:message code="userPass2"></spring:message></td>
    			<td><input type="password" id="pw2" onchange="look()" /></td>
    		</tr>
    		<tr>
    		...
    		<tr>
    			...
    			<td><input type="radio" value='<spring:message code="man"></spring:message>' name="sex" /><spring:message code="man"></spring:message><input type="radio" value='<spring:message code="woman"></spring:message>' name="sex" /><spring:message code="woman"></spring:message></td>
    		</tr>
    		<tr>
    			<td><spring:message code="userRemark"></spring:message></td>
    			<td><form:textarea path="userRemark" cols="20" rows="30" class="area"/></td>
    		</tr>
    		<tr>
    			<td>
    			</td>
    		...
    		<tr>
    			<td></td>
    			<td><input type="button" value='<spring:message code="register"></spring:message>' onclick="getday()" class="btnn"/><input type="reset" value='<spring:message code="reset"></spring:message>' class="btnn"/></td>
    		</tr>
    	</table>
    	...
    	<input name="userBirthday" type="text" style="display: none" id="userBirthday"/>
    </form:form>
    </div>
    <a href="login.jsp" class="imgg"><img src="img/goback.png"></a>
    </div>
    </div>
  </body>
</html>
